 ...
 * @author pxand
 */
public class BusquedaUsuarios extends javax.swing.JDialog {
     private ControladorUsuario controlador;
    private Usuario usuarioSeleccionado = null;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(BusquedaUsuarios.class.getName());

    /**
     * Creates new form BusquedaUsuarios
     */
    public BusquedaUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public void setControlador(ControladorUsuario controlador) throws Exception {
    ...
    private void buscarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBtnActionPerformed
        ...
        try {
            int texto = Integer.valueOf(IDpagotxt.getText().trim());
            Usuario usuario;
            usuario = controlador.buscar(texto);
    ...
    private void aceptarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarBtnActionPerformed
        ...
        try {
            usuarioSeleccionado = controlador.buscar(id);
            dispose();
        } catch (Exception e) {
    ...
    private void reiniciarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reiniciarBtnActionPerformed
         try {
             ...
             System.getLogger(BusquedaUsuarios.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
         }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BusquedaUsuarios dialog = new BusquedaUsuarios(new javax.swing.JFrame(), true);
