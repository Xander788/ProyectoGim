 ...
 * @author pxand
 */
public class BusquedaClases extends javax.swing.JDialog {
    private ControladorClase controlador;
    private Clase claseSeleccionada = null;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(BusquedaClases.class.getName());

    /**
     * Creates new form BusquedaClases
     */
    public BusquedaClases(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public void setControlador(ControladorClase controlador) throws Exception {
        this.controlador = controlador;
        CargarTabla(controlador.obtenerTodas());
    }
    ...
    private void CargarTabla(List<Clase> lista) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Clase", "Horario", "ID entrenador", "Tipo", "Capacidad"
            }
        ) {
    ...
    private void buscarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBtnActionPerformed
        try {
            ...
            Clase clase;
            clase = controlador.buscarPorId(Integer.valueOf(texto));
    ...
    private void aceptarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarBtnActionPerformed
        ...
        try {
            claseSeleccionada = controlador.buscarPorId(id);
            dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BusquedaClases dialog = new BusquedaClases(new javax.swing.JFrame(), true);
